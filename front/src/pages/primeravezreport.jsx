                ...
                <form className="w-full max-w-lg" ref={form} onChange={updateFormData}>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <input className="inputs-text-ppl" id="grid-first-name" name='nombre' type='text' value={user.name} readonly/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <input className="inputs-text-ppl" id="grid-mail"  name='correo' type='email' value={user.email} readonly/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <textarea className="appearance-none block w-full resize-none bg-gray-200 text-gray-700 border border-gray-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-motivo"  name='descripcion' type='text' placeholder="Escribe aquí tu motivo" />
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
